import{_ as n}from"./FactoryPatternStr-3c5835b7.js";import{_ as s,o as a,c as t,e as p}from"./app-d609f4f7.js";const e={},c=p(`<h2 id="formal-definition" tabindex="-1"><a class="header-anchor" href="#formal-definition" aria-hidden="true">#</a> Formal definition</h2><blockquote><p><strong>Abstract Factory</strong> is a creational design pattern that lets you produce families of related objects without specifying their concrete classes.</p></blockquote><p><strong>Factory Pattern</strong> is used to optimize code like this:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Creator</span> <span class="token punctuation">{</span>
